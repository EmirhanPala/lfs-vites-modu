...
namespace SharpUpdate
{
    ...
    internal partial class SharpUpdateDownloadForm : Form
    {
        ...
        private void webClient_DownloadProgressChanged(object sender, DownloadProgressChangedEventArgs e)
        {
            ...
            this.lblProgress.Text = String.Format("Indirilen {0} inencek olan {1}", FormatBytes(e.BytesReceived, 1, true), FormatBytes(e.TotalBytesToReceive, 1, true));
        ...
        private void webClient_DownloadFileCompleted(object sender, AsyncCompletedEventArgs e)
        {
            ...
            else
            {
                ...
                this.lblProgress.Text = "Indirme doğrulanıyor....";
