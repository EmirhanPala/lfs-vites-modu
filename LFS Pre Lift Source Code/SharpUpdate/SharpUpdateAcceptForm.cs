...
namespace SharpUpdate
{
    ...
    internal partial class SharpUpdateAcceptForm : Form
    {
        ...
        internal SharpUpdateAcceptForm(ISharpUpdatable applicationInfo, SharpUpdateXml updateInfo)
        {
            ...
            this.Text = this.applicationInfo.ApplicationName + " - Güncelleştirme Uygun";
            ...
            this.lblNewVersion.Text = String.Format("Yeni version: {0}", this.updateInfo.Version.ToString());
        }
