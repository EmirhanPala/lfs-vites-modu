...
namespace SharpUpdate
{
    ...
    public class SharpUpdater
    {
        ...
        private void DownloadUpdate(SharpUpdateXml update)
        {
            ...
            {
                MessageBox.Show("Güncelleme indirimi iptal edildi.\nBu program değiştirilmedi.", "Güncelleştirmeyi İndirme İptal Edildi", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                MessageBox.Show("Güncelleştirmeyi karşıdan yükleme ile ilgili bir sorun oluştu.\nLütfen daha sonra tekrar deneyiniz.", "Güncelleme Yükleme Hatası", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
